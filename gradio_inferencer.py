...
if __name__ == "__main__":
    ...
    interface = gr.Interface(
        ...
        inputs=[
            gr.Image(
                image_mode="RGB", sources="upload", type="numpy", label="Image", height=150
            ),
        ],
        outputs=[
            gr.Image(type="numpy", label="Predicted Heat Map", height=150),
            gr.Image(type="numpy", label="Predicted Mask", height=150),
            gr.Image(type="numpy", label="Segmentation Result", height=150),
        ],
        title="Anomalib",
